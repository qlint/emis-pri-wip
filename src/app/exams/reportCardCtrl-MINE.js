...
function($scope, $rootScope, $uibModalInstance, apiService, $dialogs, data, $timeout, $window, $parse){
	...
	var buildReportBody = function(data)
	{
		...
		$scope.performanceChart.innerHTML += '<div class="main-chart-container" id="line1Chart" ng-model="graphPoints" name="graphPoints" ng-show="isPrinting"><canvas id="line1" class="chart chart-line efficiency-chart" ng-show="isPrinting"></canvas></div>';
		// $scope.performanceChart = document.write('<div class="main-chart-container" id="line1Chart" ng-model="graphPoints" name="graphPoints"><canvas id="line1" class="chart chart-line efficiency-chart"></canvas></div>');

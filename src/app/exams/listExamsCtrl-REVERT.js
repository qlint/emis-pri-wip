...
function($scope, $rootScope, apiService, $timeout, $window, $q, $parse){
  ...
  {
    return '<div class="clickable" ng-class="{\'alert-danger\': row.entity.balance > 0, \'alert-success\' : row.entity.balance == 0}" ng-click="grid.appScope.viewExamMarks(row.entity)">' +
  ...
  $scope.gridOptions = {
    ...
    columnDefs: [
      ...
      { name: 'Pos', field: 'rank', enableColumnMenu: false, sort: {direction:'asc'}},
      { name: 'Total', field: 'total', enableColumnMenu: false,},
      { name: 'clint', field: 'tableHeader', enableColumnMenu: false,},
    ],
    exporterCsvFilename: 'exam-marks.csv',
  ...
  $scope.singleFilter = function( renderableRows )
  {
    ...
    renderableRows.forEach( function( row ) {
      var match = false;
      [ 'Student', 'rank', 'total', 'subjectName' ].forEach(function( field ){
